...
def parse_args():
    ...
    p.add_argument("--sft_sample", type=int, default=4000)
    p.add_argument("--pref_sample", type=int, default=3000)
    ...
    p.add_argument("--sft_steps", type=int, default=400)
    p.add_argument("--orpo_steps", type=int, default=300)
